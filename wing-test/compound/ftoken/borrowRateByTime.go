...
func (this *FlashToken) TestBorrowRateByTime() {
	//before test
	...
	startBlock := utils.GetTimeByTxhash(this.sdk, hash0)
	...
	endBlock := utils.GetTimeByTxhash(this.sdk, hash1)
...
func (this *FlashToken) TestBorrowRateByTime2Addr(addr string) {
