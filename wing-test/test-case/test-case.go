...
func (this *TestRunner) WingSpeed4BorrowTest(userAddr string) {
	...
	wingBalance0, err := otoken.BalanceOfOToken2(this.OntSDk, this.TestConfig.GovToken, userAddr)
	if err != nil {
	...
	wingBalance1, err := otoken.BalanceOfOToken2(this.OntSDk, this.TestConfig.GovToken, userAddr)
	if err != nil {
		log.Errorf(" wingBalance0 balance err : %v", err)
	}
